...
class RotateGestureDetector() {
    ...
    @Synchronized fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action and MotionEvent.ACTION_MASK) {
            ...
            MotionEvent.ACTION_POINTER_UP -> when (event.action) {
                MotionEvent.ACTION_POINTER_1_UP -> isFirstPointerUp = true
            }
        }
    ...
    companion object {
        ...
        private fun getAngle(xi1: Float, yi1: Float, xm1: Float, ym1: Float, xi2: Float, yi2: Float, xm2: Float, ym2: Float): Float {
